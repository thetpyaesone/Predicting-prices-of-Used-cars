...
# R2 tell us how well the linear regression model fits the data.
# Adding "broom" library,and using augment(model1) can view the predictors,response,fitted,residuals,...
